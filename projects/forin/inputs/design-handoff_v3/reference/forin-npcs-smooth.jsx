        ...
        <svg viewBox="0 0 64 80" width={width} height={height}
          ...
          {facingSide ? (
            <g>
              ...
              {armSwingB && (
                <animateTransform attributeName="transform" type="rotate"
                  values="-10 33 53; 14 33 53; -10 33 53" dur="0.5s" repeatCount="indefinite"/>
              )}
            </g>
          ) : (
            <>
          ...
          {/* ── LEGS (short, swing when walking) ──
               Side view: legs overlap into a single centered leg. */}
          {facingSide ? (
            <g>
              ...
              {legSwingA && (
                <animateTransform attributeName="transform" type="rotate"
                  values="-12 32 65; 12 32 65; -12 32 65" dur="0.5s" repeatCount="indefinite"/>
              )}
            </g>
          ) : (
            <>
