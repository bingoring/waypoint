...
It renders a pan/zoom "design canvas" with every screen as a phone-sized
artboard (402×874), grouped into sections ⓪–⑨. Section ⓪ is the **Design
System catalog** (tokens, components, characters) — the best place to read the
visual language. Sections ①–⑨ are the actual app screens.
