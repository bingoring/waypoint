...
(function () {
  ...
  function MedCenter2D({ w = 10, h = 7, TILE = 16, label, sign, signColor = '#D14B3D' }) {
    ...
    return (
      <div style={{ position: 'absolute', left: 0, top: 0, width: pw, height: ph }}>
        {/* right-side shadow: 1 tile wide, starts at the podium's right edge (pw+4),
           height = podium roof depth + rear-tower roof depth */}
        <div style={{ position: 'absolute', left: pw + 4, bottom: -4, width: 16, height: 48, background: 'rgba(40,32,28,.28)' }}/>

        {/* PODIUM base drawn FIRST so the three towers rest ON its roof */}
        ...
        {/* LEFT — dark glass tower (base flush with podium roof) */}
        <Block3D left={24} bottom={30} fw={40} fh={150} d={11}
        ...
        <Block3D left={92} bottom={30} fw={40} fh={120} d={10}
        ...
        <Block3D left={62} bottom={30} fw={32} fh={166} d={12}
        ...
        <div style={{ position: 'absolute', left: 56, bottom: 92, width: 8, height: 20, background: '#8FB8D2', border: `1.5px solid ${ink}` }}>
  ...
  function ClockTower2D({ TILE = 16 }) {
    ...
    return (
      <div style={{ position: 'absolute', left: 0, top: 0, width: TILE * 6, height: 300 }}>
        {/* right-side shadow: 1 tile wide, height = base plinth top-face depth (d=9 → ~21) */}
        <div style={{ position: 'absolute', left: 94, bottom: -4, width: 16, height: 32, background: 'rgba(40,32,28,.26)' }}/>
  ...
  function MedCenterH2D({ w = 8, h = 5, TILE = 16, label, sign, signColor = '#0E7490' }) {
    ...
    return (
      <div style={{ position: 'absolute', left: 0, top: 0, width: pw, height: ph }}>
        {/* 2.5D ground shadow — 1 tile wide, height = roof top-face depth (d=14 → ~32) */}
        <div style={{ position: 'absolute', left: pw, bottom: 0, width: 16, height: Math.round(d * 2.3), background: 'rgba(40,32,28,.30)' }}/>
  ...
  function MedCenterV2D({ w = 7, h = 6, TILE = 16, label, sign, signColor = '#C2487E' }) {
    ...
    return (
      <div style={{ position: 'absolute', left: 0, top: 0, width: pw, height: ph }}>
        {/* right-side shadow: 1 tile wide, aligned to the facade base, height = roof top-face depth */}
        <div style={{ position: 'absolute', left: pw - 8, bottom: 16, width: 16, height: 24, background: 'rgba(40,32,28,.24)' }}/>
  ...
  function MedCenterC2D({ w = 8, h = 7, TILE = 16, label, sign, signColor = '#2E9E6E' }) {
    ...
    return (
      <div style={{ position: 'absolute', left: 0, top: 0, width: pw, height: ph, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.3))' }}>
        {/* right-side shadow: 1 tile wide, height = roof top-face depth (podium d ~ 30) */}
        <div style={{ position: 'absolute', left: pw, bottom: 0, width: 16, height: 30, background: 'rgba(40,32,28,.22)' }}/>
