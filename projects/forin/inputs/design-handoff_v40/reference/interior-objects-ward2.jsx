...
(function () {
  ...
  function O2Flowmeter({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T, width: T - 6, height: T * 1.6 }}>
        <svg viewBox="0 0 10 26" width={T - 6} height={T * 1.6} shapeRendering="crispEdges">
          <ellipse cx="5.0" cy="25.0" rx="3.4" ry="2" fill="rgba(0,0,0,.16)"/>
          {/* green wall port */}
  ...
  function Nebulizer({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T - 2, width: T * 1.2, height: T * 1.5 }}>
        <svg viewBox="0 0 20 24" width={T * 1.2} height={T * 1.5} shapeRendering="geometricPrecision">
          <ellipse cx="10.0" cy="22.7" rx="6.8" ry="2.3" fill="rgba(0,0,0,.16)"/>
  ...
  function AirMattress({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T - 2, width: T * 1.2, height: T * 1.4 }}>
        <svg viewBox="0 0 20 22" width={T * 1.2} height={T * 1.4} shapeRendering="geometricPrecision">
          <ellipse cx="10.0" cy="20.7" rx="6.8" ry="2.3" fill="rgba(0,0,0,.16)"/>
          {/* TOP face (dominant) folding into a continuous short front */}
  ...
  function FallRiskSign({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T + 2, width: T - 6, height: T - 4, zIndex: 3 }}>
  ...
  function NPOBoard({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T + 2, width: T - 4, height: T - 6 }}>
        <svg viewBox="0 0 14 9" width={T - 4} height={T - 6} shapeRendering="crispEdges">
          <ellipse cx="7.0" cy="8.0" rx="4.8" ry="2" fill="rgba(0,0,0,.16)"/>
  ...
  function IsolationCart({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 6, width: T * 1.4, height: T * 2 }}>
  ...
  function LinenHamper({ x, y, tone = 'soiled' }) {
    ...
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T - 2, width: T * 1.2, height: T * 1.6 }}>
        <svg viewBox="0 0 20 26" width={T * 1.2} height={T * 1.6} shapeRendering="geometricPrecision">
          <ellipse cx="10.0" cy="24.7" rx="6.8" ry="2.3" fill="rgba(0,0,0,.16)"/>
  ...
  function SluiceSink({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 2, width: T * 1.6, height: T * 1.7 }}>
        <svg viewBox="0 0 26 28" width={T * 1.6} height={T * 1.7} shapeRendering="geometricPrecision">
          <ellipse cx="13.0" cy="26" rx="8.8" ry="3" fill="rgba(0,0,0,.16)"/>
  ...
  function SupplyBasketShelf({ x, y, w = 4, shelves = 4 }) {
    ...
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: W, height: H }}>
  ...
  function IVStorageCart({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 1.5, height: T * 1.8 }}>
