...
(function () {
  ...
  function PneumaticTube({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 6, width: T * 1.7, height: T * 1.9 }}>
        <svg viewBox="0 0 28 32" width={T * 1.7} height={T * 1.9} shapeRendering="geometricPrecision">
          <ellipse cx="14.0" cy="29.8" rx="9.5" ry="3.2" fill="rgba(0,0,0,.16)"/>
  ...
  function TubeCapsuleRack({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T + 1, width: T * 1.6, height: T - 2 }}>
        <svg viewBox="0 0 26 12" width={T * 1.6} height={T - 2} shapeRendering="crispEdges">
          <ellipse cx="13.0" cy="10" rx="8.8" ry="3" fill="rgba(0,0,0,.16)"/>
          {/* rack */}
    ...
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T, width: T - 4, height: T * 1.3 }}>
        <svg viewBox="0 0 12 18" width={T - 4} height={T * 1.3} shapeRendering="crispEdges">
          <ellipse cx="6.0" cy="17.0" rx="4.1" ry="2" fill="rgba(0,0,0,.16)"/>
  ...
  function BarcodeScanner({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T + 1, width: T - 6, height: T * 1.1 }}>
  ...
  function ATCMachine({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 10, width: T * 2.4, height: T * 2.8 }}>
        <svg viewBox="0 0 38 44" width={T * 2.4} height={T * 2.8} shapeRendering="geometricPrecision">
          <ellipse cx="19.0" cy="40.6" rx="12.9" ry="4.4" fill="rgba(0,0,0,.16)"/>
  ...
  function LASAShelf({ x, y, w = 3 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 8, width: T * w, height: T * 1.5 }}>
  ...
  function NarcoticsVault({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 8, width: T * 2, height: T * 2.4 }}>
        <svg viewBox="0 0 32 40" width={T * 2} height={T * 2.4} shapeRendering="geometricPrecision">
          <ellipse cx="16.0" cy="37.3" rx="10.9" ry="3.7" fill="rgba(0,0,0,.16)"/>
    ...
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 2.4, height: T * 2 }}>
        <svg viewBox="0 0 38 32" width={T * 2.4} height={T * 2} shapeRendering="geometricPrecision">
          <ellipse cx="19.0" cy="28.6" rx="12.9" ry="4.4" fill="rgba(0,0,0,.16)"/>
