  ...
  return (
    <div style={{
      ...
      <svg viewBox="0 0 32 48" width={ITILE * 2} height={ITILE * 3} shapeRendering="crispEdges">
          <ellipse cx="17.0" cy="41" rx="15" ry="5" fill="rgba(0,0,0,.16)"/>
      ...
      {stuffie && (
        <div style={{ position: 'absolute', right: 2, bottom: ITILE * 1.1, fontSize: 11, lineHeight: 1 }}>{stuffie}</div>
      )}
    </div>
  );
}
  ...
  return (
    <div style={{ position: 'absolute', left: x * ITILE + 4, top: y * ITILE - 4, animation: 'forinBob 1.6s ease-in-out infinite' }}>
      <svg viewBox="0 0 8 14" width="12" height="20" shapeRendering="crispEdges">
          <ellipse cx="4.0" cy="13.0" rx="2.7" ry="2" fill="rgba(0,0,0,.16)"/>
...
function ToyChest({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 4, width: ITILE * 2, height: ITILE * 1.7 }}>
      <svg viewBox="0 0 32 28" width={ITILE * 2} height={ITILE * 1.7} shapeRendering="geometricPrecision">
          <ellipse cx="16.0" cy="25.3" rx="10.9" ry="3.7" fill="rgba(0,0,0,.16)"/>
...
function SmallSlide({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 6, width: ITILE * 2.6, height: ITILE * 2.4 }}>
      <svg viewBox="0 0 42 38" width={ITILE * 2.6} height={ITILE * 2.4} shapeRendering="geometricPrecision">
          <ellipse cx="21.0" cy="34.1" rx="14.3" ry="4.9" fill="rgba(0,0,0,.16)"/>
...
function Fridge({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 5, width: ITILE * 1.3, height: ITILE * 2.3 }}>
      <svg viewBox="0 0 21 37" width={ITILE * 1.3} height={ITILE * 2.3} shapeRendering="geometricPrecision">
          <ellipse cx="10.5" cy="35.6" rx="7.1" ry="2.4" fill="rgba(0,0,0,.16)"/>
...
function RockingHorse({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 6, width: ITILE * 2.2, height: ITILE * 2, animation: 'forinBob 1.4s ease-in-out infinite' }}>
      <svg viewBox="0 0 36 34" width={ITILE * 2.2} height={ITILE * 2} shapeRendering="geometricPrecision">
          <ellipse cx="18.0" cy="30.9" rx="12.2" ry="4.1" fill="rgba(0,0,0,.16)"/>
