...
(function () {
  ...
  function TractionFrame({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 20, width: T * 2.4, height: T * 3.4, zIndex: 2 }}>
        <svg viewBox="0 0 38 54" width={T * 2.4} height={T * 3.4} shapeRendering="crispEdges">
          <ellipse cx="19.0" cy="44" rx="11" ry="3" fill="rgba(0,0,0,.16)"/>
  ...
  function CPMMachine({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 6, width: T * 2.2, height: T * 1.7 }}>
        <svg viewBox="0 0 36 28" width={T * 2.2} height={T * 1.7} shapeRendering="crispEdges">
          <ellipse cx="18.0" cy="24.9" rx="12.2" ry="4.1" fill="rgba(0,0,0,.16)"/>
  ...
  function PlasterTrapSink({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 2, width: T * 1.6, height: T * 1.9 }}>
        <svg viewBox="0 0 26 34" width={T * 1.6} height={T * 2.1} shapeRendering="geometricPrecision">
          <ellipse cx="13.0" cy="25.5" rx="9" ry="2.6" fill="rgba(0,0,0,.16)"/>
  ...
  function CastCutter({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T + 3, width: T - 4, height: T - 6 }}>
        <svg viewBox="0 0 14 10" width={T - 4} height={T - 6} shapeRendering="crispEdges">
          <ellipse cx="7.0" cy="9.0" rx="4.8" ry="2" fill="rgba(0,0,0,.16)"/>
          {/* body */}
  ...
  function CastRollShelf({ x, y, w = 3 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * w, height: T * 1.5 }}>
  ...
  function BraceRack({ x, y, w = 3 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 8, width: T * w, height: T * 2 }}>
  ...
  function AbductionPillow({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T + 1, width: T - 4, height: T * 1.2, zIndex: 2 }}>
  ...
  function PACSViewer({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 2, height: T * 1.4 }}>
