...
function XrayMachine({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 6, width: ITILE * 2, height: ITILE * 2.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
      <svg viewBox="0 0 32 42" width={ITILE * 2} height={ITILE * 2.6} shapeRendering="geometricPrecision">
        {/* mobile base seen from above (rounded chassis + casters) */}
        <rect x="4" y="24" width="24" height="14" rx="3" fill="#C7CDD4" stroke={IP.ink} strokeWidth=".7"/>
        <rect x="6" y="26" width="20" height="4" rx="1.5" fill="#E1E5EA"/>
        <text x="16" y="35" fontSize="3.4" fill="#64748B" textAnchor="middle" fontFamily="monospace">X-RAY</text>
        <ellipse cx="6" cy="38.5" rx="2" ry="1.5" fill="#2C3239" stroke={IP.ink} strokeWidth=".3"/>
        <ellipse cx="26" cy="38.5" rx="2" ry="1.5" fill="#2C3239" stroke={IP.ink} strokeWidth=".3"/>
        {/* rotating column (top face disc) */}
        <ellipse cx="10" cy="22" rx="4.5" ry="3.4" fill="#9AA2AB" stroke={IP.ink} strokeWidth=".6"/>
        <ellipse cx="10" cy="21.2" rx="2.6" ry="1.9" fill="#B8BEC6"/>
        {/* telescoping boom arm reaching out over the patient */}
        <rect x="9" y="10" width="4" height="12" rx="1.5" fill="#AEB4BC" stroke={IP.ink} strokeWidth=".5"/>
        <rect x="10" y="10.5" width="1.3" height="11" fill="#CBD0D7"/>
        <rect x="11" y="12" width="14" height="3.4" rx="1.4" fill="#AEB4BC" stroke={IP.ink} strokeWidth=".5"/>
        <rect x="11.5" y="12.5" width="13" height="1.1" fill="#CBD0D7"/>
        {/* tube head + collimator (round, over the field) with light beam */}
        <ellipse cx="24" cy="14" rx="6" ry="5.2" fill="#5B6672" stroke={IP.ink} strokeWidth=".7"/>
        <ellipse cx="24" cy="13.2" rx="4.2" ry="3.6" fill="#727E8C"/>
        <ellipse cx="24" cy="14" rx="2.2" ry="1.9" fill="#0F1A24"/>
        <ellipse cx="24" cy="14" rx="1" ry=".9" fill="#FEF08A"/>
        <ellipse cx="24" cy="22" rx="8" ry="3" fill="#FEF3C7" opacity=".3"/>{/* collimated light */}
        {/* control handle at the back of the base */}
        <rect x="12" y="37" width="8" height="2.4" rx="1.2" fill="#475569" stroke={IP.ink} strokeWidth=".4"/>
      </svg>
    </div>
  );
}
