...
(function () {
  ...
  function CRRTMachine({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 14, width: T * 2, height: T * 3.4 }}>
        <svg viewBox="0 0 32 54" width={T * 2} height={T * 3.4} shapeRendering="geometricPrecision">
          <ellipse cx="16.0" cy="51.3" rx="10.9" ry="3.7" fill="rgba(0,0,0,.16)"/>
  ...
  function IVPumpTower({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 22, width: T, height: T * 3.4 }}>
        <svg viewBox="0 0 16 54" width={T} height={T * 3.4} shapeRendering="crispEdges">
          <ellipse cx="8.0" cy="53.0" rx="5.4" ry="2" fill="rgba(0,0,0,.16)"/>
          {/* hook + 2 IV bags */}
  ...
  function ICPMonitor({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 1, top: y * T - 6, width: T - 2, height: T * 1.6 }}>
  ...
  function TTMUnit({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 1.6, height: T * 2.4 }}>
        <svg viewBox="0 0 26 38" width={T * 1.6} height={T * 2.4} shapeRendering="geometricPrecision">
          <ellipse cx="13.0" cy="36" rx="8.8" ry="3" fill="rgba(0,0,0,.16)"/>
  ...
  function FoleyBag({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 4, top: y * T + 2, width: T - 8, height: T * 1.2 }}>
        <svg viewBox="0 0 8 16" width={T - 8} height={T * 1.2} shapeRendering="crispEdges">
          <ellipse cx="4.0" cy="15.0" rx="2.7" ry="2" fill="rgba(0,0,0,.16)"/>
          {/* tube */}
  ...
  function Intercom({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T + 1, width: T - 6, height: T * 1.3 }}>
    ...
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T, width: T - 4, height: T * 1.4 }}>
        <svg viewBox="0 0 12 22" width={T - 4} height={T * 1.4} shapeRendering="crispEdges">
          <ellipse cx="6.0" cy="21.0" rx="4.1" ry="2" fill="rgba(0,0,0,.16)"/>
          {/* sign */}
