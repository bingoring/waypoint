...
(function () {
  ...
  function Greeting({ done }) {
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'flex-end', gap: 10, padding: '48px 16px 12px' }}>
        ...
        {/* 홈에서만: 내 캐릭터가 인사 */}
        <div style={{ width: 58, height: 58, flexShrink: 0, background: t.cream, border: `3px solid ${t.ink}`,
  ...
  function StreakStrip() {
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, background: t.cream,
        border: `3px solid ${t.ink}`, boxShadow: `3px 3px 0 0 ${t.ink}`, padding: '11px 13px', margin: '12px 16px 0' }}>
        <div style={{ textAlign: 'center', flexShrink: 0 }}>
          ...
          <div style={{ fontFamily: '"Galmuri11",monospace', fontSize: 9, color: t.textSoft }}>연속</div>
        </div>
        <div style={{ width: 3, alignSelf: 'stretch', background: t.ink + '22' }}/>
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontFamily: '"Galmuri11",monospace', fontSize: 10, color: t.textSoft, marginBottom: 7 }}>이번 주</div>
    ...
    return (
      <div style={{ display: 'flex', gap: 10, margin: '13px 16px 0', background: t.peach,
        ...
        <div style={{ minWidth: 0, flex: 1, marginTop: 2 }}>
          ...
          <div style={{ fontFamily: '"DungGeunMo",monospace', fontSize: 9, color: t.textSoft, marginTop: 5 }}>— 수간호사 Emma · ER</div>
        </div>
      </div>
    );
  }
  ...
  function PhraseOfDay() {
    const t = T();
    return (
      <div style={{ margin: '13px 16px 0', background: '#fff', border: `3px solid ${t.ink}`,
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
          ...
          <div style={{ flex: 1 }}/>
          <span style={{ fontFamily: '"Galmuri11",monospace', fontSize: 9, color: t.textFaint }}>탭하면 뜻 보기</span>
        </div>
  ...
  function Doors() {
    ...
    const door = (icon, title, sub, bg) => (
      <div style={{ flex: 1, background: bg, border: `3px solid ${t.ink}`, boxShadow: `3px 3px 0 0 ${t.ink}`, padding: '12px 11px' }}>
        ...
        <div style={{ fontFamily: '"Galmuri11",monospace', fontSize: 9.5, color: t.textSoft, marginTop: 3, lineHeight: 1.4, whiteSpace: 'pre-line' }}>{sub}</div>
      </div>
    );
    return (
      <div style={{ display: 'flex', gap: 10, margin: '13px 16px 0' }}>
        {door('🗺', '둘러보기', '건물·층에서\n원하는 과 고르기', '#fff')}
        {door('📋', '오늘의 상황', '지금 벌어진 일\n5건 대기중', t.blue || '#BAE6FD')}
      </div>
    );
  }
  ...
  function OneReview() {
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '13px 16px 0',
        background: '#fff', border: `3px solid ${t.ink}`, boxShadow: `3px 3px 0 0 ${t.ink}`, padding: '10px 12px' }}>
        <div style={{ width: 26, height: 26, flexShrink: 0, background: t.yellow, border: `2px solid ${t.ink}`,
          display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13 }}>📓</div>
        <div style={{ minWidth: 0, flex: 1 }}>
          <div style={{ fontFamily: '"Galmuri11",monospace', fontSize: 11.5, color: t.ink, lineHeight: 1.25 }}>어제 틀린 표현 하나만 다시 볼까요?</div>
          <div style={{ fontFamily: '"DungGeunMo",monospace', fontSize: 9.5, color: t.textSoft, marginTop: 3 }}>“radiate” · 1분</div>
        </div>
  ...
  function PeerTicker() {
    ...
    return (
      <div style={{ margin: '13px 16px 0', background: t.cream, border: `3px solid ${t.ink}`, boxShadow: `3px 3px 0 0 ${t.ink}` }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 12px 6px', borderBottom: `2px dotted ${t.ink}33` }}>
          ...
          <div style={{ flex: 1 }}/>
          <span style={{ fontFamily: '"DungGeunMo",monospace', fontSize: 9.5, color: t.textSoft }}>프로필 ›</span>
        </div>
        {rows.map((r, i) => (
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '7px 12px',
            ...
            <span style={{ fontFamily: '"Galmuri11",monospace', fontSize: 10, color: t.textSoft, minWidth: 0, flex: 1, lineHeight: 1.25 }}>{r[2]}</span>
        ...
        <div style={{ padding: '8px 12px', borderTop: `2px dotted ${t.ink}33`, display: 'flex', alignItems: 'center', gap: 7 }}>
          <span style={{ fontFamily: '"Galmuri11",monospace', fontSize: 10, color: t.textSoft, flex: 1 }}>동료 관리는 프로필에서</span>
