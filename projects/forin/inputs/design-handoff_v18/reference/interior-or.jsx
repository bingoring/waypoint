...
function Sink({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 4, width: ITILE * 2, height: ITILE * 2 }}>
...
function SurgicalLight({ x, y }) {
  ...
  return (
    <div style={{ position: 'absolute', left: x * ITILE - 16, top: y * ITILE - 12, width: ITILE * 4, height: ITILE * 3, zIndex: 1 }}>
      <svg viewBox="0 0 64 48" width={ITILE * 4} height={ITILE * 3} shapeRendering="geometricPrecision">
          <ellipse cx="32.0" cy="41.6" rx="21.8" ry="7.4" fill="rgba(0,0,0,.16)"/>
...
function AnesthesiaMachine({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 8, width: ITILE * 1.8, height: ITILE * 2.2 }}>
      <svg viewBox="0 0 30 36" width={ITILE * 1.8} height={ITILE * 2.2} shapeRendering="geometricPrecision">
          <ellipse cx="15.0" cy="33.5" rx="10.2" ry="3.5" fill="rgba(0,0,0,.16)"/>
...
function InstrumentTray({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 4, width: ITILE * 1.9, height: ITILE * 1.6 }}>
      <svg viewBox="0 0 30 26" width={ITILE * 1.9} height={ITILE * 1.6} shapeRendering="geometricPrecision">
          <ellipse cx="15.0" cy="23.5" rx="10.2" ry="3.5" fill="rgba(0,0,0,.16)"/>
