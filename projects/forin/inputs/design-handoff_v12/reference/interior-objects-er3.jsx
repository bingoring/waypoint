...
(function () {
  ...
  function SecurityScanner({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 2, height: T * 1.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function MetalDetector({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 10, width: T * 2, height: T * 2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
  ...
  function BarcodePrinter({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T + 2, width: T - 6, height: T - 4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function MedFridge({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 1, top: y * T - 6, width: T - 2, height: T * 1.8, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function BoltedBed({ x, y, occupied }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T, width: T * 2, height: T * 3, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.2))' }}>
  ...
  function CCTVCamera({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T, width: T - 2, height: T - 4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.25))' }}>
  ...
  function Sofa({ x, y, w = 2, color = '#8FA9C4' }) {
    ...
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 6, width: T * w, height: T * 1.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
  ...
  function CoffeeTable({ x, y, w = 2 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T + 1, width: T * w, height: T, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function TissueBox({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 4, top: y * T + 4, width: T - 8, height: T - 6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
  ...
  function FloorLamp({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T - 14, width: T - 6, height: T * 2.1, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
  ...
  function FramedPicture({ x, y, w = 2 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T + 1, width: T * w, height: T - 4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.2))' }}>
  ...
  function DeconShower({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T - 6, width: T - 4, height: T * 1.9, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
  ...
  function ChemDrum({ x, y, tone = 'chem' }) {
    ...
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T - 4, width: T - 4, height: T * 1.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function NurseStationDesk({ x, y, w = 10, h = 6 }) {
    ...
    return (
      <div style={{ position: 'absolute', left: x * 16, top: y * 16 - R, width: W, height: TH, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.3))' }}>
