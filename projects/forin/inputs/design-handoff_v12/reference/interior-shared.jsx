...
function IMonitor({ x, y, beep }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 8, width: ITILE, height: ITILE * 2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
      {/* wheeled base */}
...
function IIV({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 22, width: ITILE, height: ITILE * 2.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
      ...
      <div style={{ position: 'absolute', left: 1, top: 14, width: 14, height: 14,
        filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.2))' }}>
...
function IChair({ x, y, color = '#FED7AA', facing = 'down' }) {
  ...
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - ITILE * 0.5, width: ITILE, height: ITILE * 1.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
...
function ICabinet({ x, y, w = 2, h = 1, variant, kind, label }) {
  ...
  return (
    <div style={{
      position: 'absolute', left: x * ITILE, top: y * ITILE,
      width: w * ITILE, height: h * ITILE,
      filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))',
    }}>
...
function IPlant({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 6, width: ITILE, height: ITILE * 1.3, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
