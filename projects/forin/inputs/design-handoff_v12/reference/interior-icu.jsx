...
function Ventilator({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 8, width: ITILE * 1.6, height: ITILE * 2.9, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
...
function CrashCart({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 3, width: ITILE * 1.4, height: ITILE * 1.9, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
...
function CoffeeMachine({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 4, width: ITILE * 1.3, height: ITILE * 1.7, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
...
function PyxisMachine({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 3, width: ITILE * 2, height: ITILE * 2.1, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
