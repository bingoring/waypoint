...
(function () {
  ...
  function Gurney({ x, y, occupied }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 2, height: T * 3 + 8, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.3))' }}>
  ...
  function Defib({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 1.5, height: T * 2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function OxygenTank({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T - 2, width: T - 4, height: T + 4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function GloveDispenser({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T, width: T - 4, height: T - 2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.25))' }}>
  ...
  function SharpsContainer({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T, width: T - 4, height: T, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function HandSanitizer({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 4, top: y * T, width: T - 8, height: T - 4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
  ...
  function EKG({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 2, width: T * 1.4, height: T * 2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function CompCart({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T, height: T * 2.2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function Sink({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 2, width: T, height: T * 1.3, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.25))' }}>
  ...
  function Whiteboard({ x, y, w = 3 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T, width: T * w, height: T - 4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.25))' }}>
  ...
  function BPCuff({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T, width: T - 4, height: T, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.25))' }}>
        <svg viewBox="0 0 12 14" width={T - 4} height={T} shapeRendering="crispEdges">
          {/* top face */}
  ...
  function SuctionUnit({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 1, top: y * T - 2, width: T - 2, height: T * 1.4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function Wheelchair({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 1.5, height: T * 1.7, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
