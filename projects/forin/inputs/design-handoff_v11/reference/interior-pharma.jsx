...
function Kiosk({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 4, width: ITILE * 1.3, height: ITILE * 2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
...
function CountingBench({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 3, width: ITILE * 4, height: ITILE * 1.7, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.2))' }}>
...
function Fridge({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 4, width: ITILE * 1.3, height: ITILE * 1.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
...
function CSSafe({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 3, width: ITILE * 1.7, height: ITILE * 1.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
...
function MedCart({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 3, width: ITILE * 1.5, height: ITILE * 1.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
...
function LaminarHood({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 4, width: ITILE * 3, height: ITILE * 2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
...
function PrintLabel({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 3, width: ITILE * 1.6, height: ITILE * 1.5, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
