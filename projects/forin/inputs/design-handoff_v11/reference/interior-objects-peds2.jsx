...
(function () {
  ...
  function Incubator({ x, y, occupied = true }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 8, width: T * 2.2, height: T * 2.5, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
  ...
  function PhototherapyLamp({ x, y, w = 2 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 8, width: T * w, height: T * 1.9, zIndex: 1, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function MetalCrib({ x, y, occupied, stuffie }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T, width: T * 2, height: T * 3, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
        ...
        {stuffie && <div style={{ position: 'absolute', right: 3, bottom: T * 1.2, fontSize: 11, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.3))' }}>{stuffie}</div>}
      </div>
    );
  }
  ...
  function IVBoard({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T + 3, width: T - 6, height: T - 6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
  ...
  function BabyScale({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 1.5, height: T * 1.5, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function StadiometerScale({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 20, width: T * 1.4, height: T * 3, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function TongueDepressorJar({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 4, top: y * T + 3, width: T - 8, height: T - 5, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.2))' }}>
  ...
  function StickerRoll({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 4, top: y * T + 4, width: T - 8, height: T - 6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.2))' }}>
  ...
  function DosingChart({ x, y, w = 2 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T, width: T * w, height: T * 1.2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
  ...
  function MilkFridge({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T - 2, top: y * T - 5, width: T * 1.5, height: T * 2.3, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
