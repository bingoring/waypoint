...
(function () {
  ...
  function Dermatoscope({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 16, width: T * 1.2, height: T * 2.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
  ...
  function WoodsLamp({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T, width: T - 4, height: T * 1.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function UVBooth({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 16, width: T * 2.4, height: T * 3.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.3))' }}>
  ...
  function HandUVBox({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 2, width: T * 1.4, height: T * 1.3, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function GoggleSanitizer({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 1, top: y * T, width: T - 2, height: T * 1.5, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
  ...
  function BiopsyKit({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 6, width: T * 1.8, height: T * 1.4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function CryoTank({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 1.2, height: T * 1.9, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
  ...
  function CO2Laser({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 14, width: T * 1.5, height: T * 2.8, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function LesionChart({ x, y, w = 2 }) {
    ...
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T, width: T * w, height: T * 1.4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
