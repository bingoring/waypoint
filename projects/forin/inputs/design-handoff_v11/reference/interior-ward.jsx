...
function MealCart({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 2, width: ITILE * 1.6, height: ITILE * 1.8, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
...
function SharpsBin({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE + 3, top: y * ITILE + 2, width: ITILE - 6, height: ITILE - 2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
...
function IsoSign({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE - 4, top: y * ITILE - 14, zIndex: 4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
...
function DedicatedBP({ x, y }) {
  return (
    <div style={{ position: 'absolute', left: x * ITILE, top: y * ITILE - 12, width: ITILE, height: ITILE * 2.2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
