...
(function () {
  ...
  function PCAPump({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 18, width: T, height: T * 3, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function JPDrain({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T + 2, width: T - 6, height: T * 1.3, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
  ...
  function Hemovac({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T + 2, width: T - 4, height: T - 2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
  ...
  function NGSuction({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T, width: T * 1.2, height: T * 1.8, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function SCDDevice({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 3, width: T * 1.6, height: T * 1.7, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function WalkerRack({ x, y, w = 3 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T, width: T * w, height: T * 1.4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.2))' }}>
  ...
  function OPScheduleBoard({ x, y, w = 4 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T, width: T * w, height: T * 1.5, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function StapleRemover({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T + 4, width: T - 6, height: T - 8, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.2))' }}>
  ...
  function AbdoBinder({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T + 3, width: T - 6, height: T - 6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.2))' }}>
