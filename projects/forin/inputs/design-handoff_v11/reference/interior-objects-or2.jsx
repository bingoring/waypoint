...
(function () {
  ...
  function BairHugger({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 1.6, height: T * 2.1, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function Bovie({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 1.3, height: T * 1.9, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
  ...
  function KickBucket({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T + 2, width: T - 4, height: T - 2, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
  ...
  function TimeoutBoard({ x, y, w = 3 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T, width: T * w, height: T * 1.3, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
  ...
  function RoboticConsole({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 8, width: T * 2.2, height: T * 2.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.3))' }}>
  ...
  function LapTower({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 18, width: T * 1.5, height: T * 3.4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.3))' }}>
  ...
  function CO2Insufflator({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 1, top: y * T - 2, width: T - 2, height: T * 1.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.26))' }}>
  ...
  function ScrubDispenser({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 1, top: y * T - 2, width: T - 2, height: T * 1.6, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.24))' }}>
        <svg viewBox="0 0 14 26" width={T - 2} height={T * 1.6} shapeRendering="geometricPrecision">
  ...
  function ConsentClipboard({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T + 3, width: T - 6, height: T - 4, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.22))' }}>
  ...
  function SoiledCart({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 1.3, height: T * 1.7, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.28))' }}>
  ...
  function ORBoomMonitor({ x, y, w = 2 }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 6, width: T * w, height: T * 1.6, zIndex: 1, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.3))' }}>
  ...
  function CArm({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 10, width: T * 2.2, height: T * 2.8, filter: 'drop-shadow(3px 0px 0 rgba(0,0,0,.3))' }}>
