...
function NbIcon({ name, size = 20, color = NB.ink, style }) {
  ...
  const G = {
    ...
    mic: <g><rect x="9.6" y="3.5" width="4.8" height="10.5" rx="2.4" fill={NB.wash.red} {...P}/><path d="M6.3 11.2 A5.7 5.7 0 0 0 17.7 11.2" {...P}/><path d="M12 16.9 V19.5 M9.4 19.5 H14.6" {...P}/></g>,
    ...
    faceAngry: <g><circle cx="12" cy="12" r="8" fill={NB.wash.peach} {...P}/><path d="M7.5 8.5 L10.5 10 M16.5 8.5 L13.5 10" {...P}/><circle cx="9.5" cy="12" r=".9" fill={NB.ink} stroke="none"/><circle cx="14.5" cy="12" r=".9" fill={NB.ink} stroke="none"/><path d="M9.5 16 Q12 14.3 14.5 16" {...P}/></g>,
    ...
    drop: <g><path d="M12 4 C14.3 7.6 16.8 10 16.8 13.4 C16.8 16.4 14.7 18.8 12 18.8 C9.3 18.8 7.2 16.4 7.2 13.4 C7.2 10 9.7 7.6 12 4 Z" fill={NB.wash.blue} {...P}/><path d="M9.7 13.8 Q9.7 15.9 11.3 16.4" fill="none" stroke="#fff" strokeWidth="1.6" strokeLinecap="round"/></g>,
  };
