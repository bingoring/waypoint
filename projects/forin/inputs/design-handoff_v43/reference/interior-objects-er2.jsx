...
(function () {
  ...
  function TicketDispenser({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T - 8, width: T - 4, height: T * 1.6 }}>
  ...
  function BrochureRack({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 1, top: y * T - 4, width: T - 2, height: T * 1.4 }}>
        <svg viewBox="0 0 14 22" width={T - 2} height={T * 1.4} shapeRendering="crispEdges">
          <ellipse cx="7.0" cy="21.0" rx="4.8" ry="2" fill="rgba(0,0,0,.16)"/>
          {/* back board */}
  ...
  function DeskPhone({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T + 4, width: T - 6, height: T - 4 }}>
  ...
  function VitalsCart({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 1, top: y * T - 6, width: T - 2, height: T * 2.1 }}>
        <svg viewBox="0 0 14 34" width={T - 2} height={T * 2.1} shapeRendering="geometricPrecision">
          <ellipse cx="7.0" cy="29.6" rx="5" ry="1.7" fill="rgba(0,0,0,.16)"/>
  ...
  function WaterCooler({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T - 6, width: T - 6, height: T * 1.5 }}>
        <svg viewBox="0 0 10 24" width={T - 6} height={T * 1.5} shapeRendering="geometricPrecision">
          <ellipse cx="5.0" cy="23.0" rx="3.4" ry="2" fill="rgba(0,0,0,.16)"/>
          {/* full silhouette */}
  ...
  function IVPump({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 22, width: T, height: T * 2.8 }}>
        <svg viewBox="0 0 16 46" width={T} height={T * 2.8} shapeRendering="crispEdges">
          <ellipse cx="8.0" cy="45.0" rx="5.4" ry="2" fill="rgba(0,0,0,.16)"/>
          {/* hook */}
  ...
  function WasteBin({ x, y, tone = 'general' }) {
    ...
    return (
      <div style={{ position: 'absolute', left: x * T + 3, top: y * T, width: T - 6, height: T * 1.3 }}>
        <svg viewBox="0 0 10 18" width={T - 6} height={T * 1.3} shapeRendering="crispEdges">
          <ellipse cx="5.0" cy="17.0" rx="3.4" ry="2" fill="rgba(0,0,0,.16)"/>
          {/* pedal lid top */}
  ...
  function PPEStand({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 1, top: y * T - 8, width: T - 2, height: T * 2.1 }}>
        <svg viewBox="0 0 14 34" width={T - 2} height={T * 2.1} shapeRendering="crispEdges">
          <ellipse cx="7.0" cy="33.0" rx="4.8" ry="2" fill="rgba(0,0,0,.16)"/>
          {/* rail top */}
  ...
  function Otoscope({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T + 1, width: T - 4, height: T }}>
