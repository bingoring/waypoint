...
(function () {
  ...
  function UltrasoundCart({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 6, width: T * 1.4, height: T * 2.4 }}>
        <svg viewBox="0 0 22 38" width={T * 1.4} height={T * 2.4} shapeRendering="geometricPrecision">
          <ellipse cx="11.0" cy="36.0" rx="6.5" ry="1.8" fill="rgba(0,0,0,.16)"/>
  ...
  function XrayViewbox({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T, width: T * 2, height: T * 1.4 }}>
        <svg viewBox="0 0 32 22" width={T * 2} height={T * 1.4} shapeRendering="crispEdges">
          <ellipse cx="16.0" cy="19.3" rx="10.9" ry="3.7" fill="rgba(0,0,0,.16)"/>
  ...
  function CastCart({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 1.4, height: T * 1.8 }}>
  ...
  function Crutches({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T - 6, width: T, height: T * 2 }}>
        <svg viewBox="0 0 12 34" width={T} height={T * 2} shapeRendering="crispEdges">
          <ellipse cx="6.0" cy="33.0" rx="4.1" ry="2" fill="rgba(0,0,0,.16)"/>
          {[2,6].map((ox,i)=>(
            <g key={i}>
  ...
  function DermLamp({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 8, width: T * 1.3, height: T * 2.2 }}>
        <svg viewBox="0 0 20 36" width={T * 1.3} height={T * 2.2} shapeRendering="crispEdges">
          <ellipse cx="10.0" cy="34.7" rx="6.8" ry="2.3" fill="rgba(0,0,0,.16)"/>
          {/* magnifier ring head */}
  ...
  function LaserUnit({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 4, width: T * 1.3, height: T * 2.2 }}>
    ...
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T, width: T - 4, height: T * 1.3 }}>
        <svg viewBox="0 0 12 16" width={T - 4} height={T * 1.3} shapeRendering="geometricPrecision">
          <ellipse cx="6.0" cy="15.0" rx="4.1" ry="2" fill="rgba(0,0,0,.16)"/>
  ...
  function BoneModel({ x, y }) {
    return (
      <div style={{ position: 'absolute', left: x * T + 2, top: y * T - 8, width: T - 4, height: T * 2 }}>
        <svg viewBox="0 0 12 32" width={T - 4} height={T * 2} shapeRendering="crispEdges">
          <ellipse cx="6.0" cy="31.0" rx="4.1" ry="2" fill="rgba(0,0,0,.16)"/>
          {/* skull */}
  ...
  function ClinicReception({ x, y, w = 6, tone = '#0E7490', label = '접수' }) {
    const px = w * T;
    return (
      <div style={{ position: 'absolute', left: x * T, top: y * T - 6, width: px, height: T * 2.4 }}>
