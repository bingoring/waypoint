...
(function () {
  ...
  function GurneyV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 56, height: 96, filter: 'drop-shadow(3px 4px 0 rgba(0,0,0,.3))' }}>
  ...
  function DefibV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 40, height: 72, filter: 'drop-shadow(3px 4px 0 rgba(0,0,0,.3))' }}>
  ...
  function VentilatorV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 36, height: 84, filter: 'drop-shadow(3px 4px 0 rgba(0,0,0,.3))' }}>
  ...
  function IVStandV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 32, height: 96, filter: 'drop-shadow(2px 4px 0 rgba(0,0,0,.28))' }}>
  ...
  function CribV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 64, height: 96, filter: 'drop-shadow(3px 4px 0 rgba(0,0,0,.3))' }}>
  ...
  function CrashCartV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 40, height: 80, filter: 'drop-shadow(3px 4px 0 rgba(0,0,0,.3))' }}>
  ...
  function SurgLightV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 88, height: 56, filter: 'drop-shadow(3px 5px 0 rgba(0,0,0,.25))' }}>
  ...
  function PyxisV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 40, height: 84, filter: 'drop-shadow(3px 4px 0 rgba(0,0,0,.32))' }}>
  ...
  function LaminarHoodV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 96, height: 80, filter: 'drop-shadow(3px 5px 0 rgba(0,0,0,.28))' }}>
  ...
  function SinkV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 56, height: 64, filter: 'drop-shadow(3px 4px 0 rgba(0,0,0,.28))' }}>
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          imageRendering: 'pixelated', filter: 'drop-shadow(2px 3px 0 rgba(0,0,0,.25))',
        }}>
  ...
  function FridgeV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 56, height: 96, filter: 'drop-shadow(4px 5px 0 rgba(0,0,0,.32))' }}>
        <svg viewBox="0 0 28 48" width="56" height="96" shapeRendering="crispEdges">
  ...
  function DeskV2({ x = 0, y = 0, w = 144, h = 96 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: w, height: h, filter: 'drop-shadow(3px 4px 0 rgba(0,0,0,.3))' }}>
  ...
  function ChairV2({ x = 0, y = 0, color = '#EF4444' }) {
    ...
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 40, height: 56, filter: 'drop-shadow(2px 3px 0 rgba(0,0,0,.28))' }}>
  ...
  function DresserV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 72, height: 96, filter: 'drop-shadow(3px 4px 0 rgba(0,0,0,.3))' }}>
  ...
  function MonitorV2({ x = 0, y = 0 }) {
    return (
      <div style={{ position: 'absolute', left: x, top: y, width: 56, height: 72, filter: 'drop-shadow(3px 4px 0 rgba(0,0,0,.32))' }}>
