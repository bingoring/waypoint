...
(function () {
  ...
  function ScreenExplore() {
    ...
    const buildings = [
      ...
      { x: 0,  y: 56, w: 4, h: 3, roof: { mid: P.roofTeal, dk: P.roofTealDk, lt: '#85B5A8' }, label: '내과', sign: '🫀 INTERNAL', signColor: '#0E7490', emblem: '🫀' },
      ...
      { x: 18, y: 56, w: 4, h: 3, roof: { mid: P.roofWhite, dk: P.roofWhiteDk, lt: '#F2EDDE' }, label: '정형외과', sign: '🦴 ORTHO', signColor: '#B45309', emblem: '🦴' },
