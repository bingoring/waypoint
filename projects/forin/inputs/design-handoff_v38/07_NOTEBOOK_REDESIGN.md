...
- **미니게임 허브**(GameHub) — 쉬는 시간은 간호와 무관한 캐주얼 5종: 종이비행기 날리기(타이밍 게이지)·펜 뚜껑 스피드(반응속도)·낙서 짝 맞추기(기억력)·완벽한 원 그리기(정확도 100점 채점)·복도 달리기(러너). 하루 3판 + **이번 주 동료 랭킹**(일요일 리셋, 내 순위 형광펜) + 1위에게 도전장 보내기(같은 판으로 대결).
