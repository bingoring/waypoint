...
function ScreenDSFurniture() {
  ...
  return (
    ...
    >
      ...
      {/* ─── Reception ─── */}
      <DSSection title="◆ Reception desk" hint="Forin.Reception — w 가변">
        <DSGrid minItem={220}>
          <DSCard name="Reception 4×2" sub="기본 — 모니터+클립보드" code='w={4} h={2}' previewH={140}>
            <DSTileFrame width={150} height={70}>
              <F.Reception x={0} y={0} w={4} h={2} label="NURSE STATION"/>
            </DSTileFrame>
          </DSCard>
          <DSCard name="Reception 6×2" sub="긴 카운터" code='w={6}' previewH={140}>
            <DSTileFrame width={200} height={70}>
              <F.Reception x={0} y={0} w={6} h={2} label="WELCOME DESK"/>
            </DSTileFrame>
          </DSCard>
          <DSCard name="Reception 3×1" sub="컴팩트" code='h={1}' previewH={120}>
            <DSTileFrame width={120} height={50}>
              <F.Reception x={0} y={0} w={3} h={1} label="PICKUP"/>
            </DSTileFrame>
          </DSCard>
        </DSGrid>
      </DSSection>
