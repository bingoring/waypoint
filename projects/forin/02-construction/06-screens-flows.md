...
> ⚠️ **레퍼런스 JSX 부재:** `04_SCREENS ⑨`·README는 `screens-review-lab.jsx`를 가리키지만 `reference/`에 **해당 파일이 없음**
> (마크다운 명세만 존재). 구현 시 04_SCREENS ⑨ 명세 + 기존 컴포넌트(PhraseCard 구조)·`screens-progress.jsx` 톤을 따른다.
> 필요하면 사용자에게 JSX 추가 요청.
