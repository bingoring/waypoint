...
- 화면 명세: [`../inputs/design-handoff_v4/04_SCREENS.md`](../inputs/design-handoff_v4/04_SCREENS.md)
...
> ✅ **레퍼런스 JSX 확보(handoff v2, 2026-06-12):** `screens-review-lab.jsx`가 `design-handoff_v4/reference/`에 추가됨
