...
### 긴급도 큐레이션 (2026-08-10 · 250 토픽 전수 검토)
기준: **상황이 지금 벌어지고 있고 대응이 곧 과제인가.** 주제가 아무리 무거워도 교육·상담·
인계는 routine으로 둔다("낙상 외상 사정"은 응급, "낙상 예방 교육"은 수업).
- **27 토픽 → 270/2800 시나리오** (critical 70 · urgent 200)
- 부서 분포: ER 60 · PSYCH 40 · ICU 40 · SPD 30 · DIAL 20 · PEDS 20 · PICU 20 ·
  HOSPICE/LD/NICU/RAD 각 10 — **11개 부서**. 응급이 ER 전용이 아님이 데이터로 확인된다
- 추가·수정은 `cmd/gencontent/banks.go`의 `urgentTopics`(제목 → 등급) 후 재생성
