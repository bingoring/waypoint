...
| 여성소아 외래 | [womenkids-opd/](womenkids-opd/build-spec-index.md) | ✅ 구현 (v16 신규·Phase1, peds 1F 교체) | `INT-WOMENKIDS-OPD-00001` | `interior-womenkids-opd.jsx` (objects: ld2 FetalMonitor + peds/clinic 재사용) |
| 가족 분만실 L&D (3F 통합) | [ld/](ld/build-spec-index.md) | ✅ 구현 (v16 신규·Phase2) | `INT-LD-00001` | `interior-ld.jsx` + `interior-objects-ld2.jsx` (L&D+산후+신생아 통합) |
| NICU 신생아 중환자실 | [nicu/](nicu/build-spec-index.md) | ✅ 구현 (v16 신규·Phase2, WOMEN 4F) | `INT-NICU-00001` | `interior-nicu.jsx` + `interior-objects-nicu2.jsx` |
| PICU 소아 중환자실 | [picu/](picu/build-spec-index.md) | ✅ 구현 (v16 신규·Phase2, WOMEN 4F sub-선택) | `INT-PICU-00001` | `interior-picu.jsx` + `interior-objects-picu2.jsx` |
| 영상의학과 Radiology | [rad/](rad/build-spec-index.md) | ✅ 구현 (v16 신규·Phase3, DX 1F) | `INT-RAD-00001` | `interior-rad.jsx` + `interior-objects-rad2.jsx` |
...
| 완화의료·호스피스 Hospice | [hospice/](hospice/build-spec-index.md) | ✅ 구현 (v16 신규·Phase4, ONCO 4F sub-선택) | `INT-HOSPICE-00001` | `interior-hospice.jsx` + `interior-objects-hospice2.jsx` |
| 치매·노인병동 Geriatric | [geri/](geri/build-spec-index.md) | ✅ 구현 (v16 신규·Phase4, ONCO 4F sub-선택) | `INT-GERI-00001` | `interior-geri.jsx` + `interior-objects-geri2.jsx` |
| 정신과 폐쇄병동 Psych | [psych/](psych/build-spec-index.md) | ✅ 구현 (v16 신규·Phase4, ONCO 2F) | `INT-PSYCH-00001` | `interior-psych.jsx` + `interior-objects-psych2.jsx` |
| 재활치료실 PT/OT Rehab | [rehab/](rehab/build-spec-index.md) | ✅ 구현 (v16 신규·Phase4, ONCO 1F) | `INT-REHAB-00001` | `interior-rehab.jsx` + `interior-objects-rehab2.jsx` |
| 간호부·감염관리·시뮬랩 Sim | [sim/](sim/build-spec-index.md) | ✅ 구현 (v16 신규·Phase5, ADMIN 3F) | `INT-SIM-00001` | `interior-sim.jsx` + `interior-objects-sim2.jsx` |
| 락커·휴게실·식당 Lounge | [lounge/](lounge/build-spec-index.md) | ✅ 구현 (v16 신규·Phase5, ADMIN 2F) | `INT-LOUNGE-00001` | `interior-lounge.jsx` + `interior-objects-lounge2.jsx` |
| 중앙공급·영양·하역 SPD | [spd/](spd/build-spec-index.md) | ✅ 구현 (v16 신규·Phase5, ADMIN 1F) | `INT-SPD-00001` | `interior-spd.jsx` + `interior-objects-spd2.jsx` |
| 영안실·부검실 Morgue | [morgue/](morgue/build-spec-index.md) | ✅ 구현 (v16 신규·Phase5, ADMIN B1) | `INT-MORGUE-00001` | `interior-morgue.jsx` + `interior-objects-morgue2.jsx` |
