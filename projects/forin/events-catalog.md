...
**⚠️ 비주얼 제약 → 결정 (A, 2026-06-08):** 핸드오프 탐험 인테리어는 5개(ER/OR/ICU/Peds/Pharmacy)뿐.
**MVP는 이 5개 워드 내에서 300+에 집중**한다(임상 상황이 충분, 비주얼 완성도 100%).
신규 진료과(내과·외과·정형외과·피부과 …)는 **로드맵** — 신규 인테리어 art 준비 시 추가.
(일부 진료과를 상황판 전용으로 먼저 노출하는 것은 후속 옵션.)
