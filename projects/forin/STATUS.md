...
> 11 도메인 · 35주제 · 각 21 상황(기초 6/응용 9/위기 6) = 735. **완료(8/29)**: ER(736) · ICU · OR · WARD · PEDS · NICU ·
> PICU · LD (각 735). 누적 태깅 5881 · 280주제. 부서별 코어는 `core-*-<code>`(dept 스코프)로 그 부서 트랙을 이끈다(D-P2-D). 화자
