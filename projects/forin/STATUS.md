...
> 11 도메인 · 35주제 · 각 21 상황(기초 6/응용 9/위기 6) = 735. **완료(10/29)**: ER(736) · ICU · OR · WARD · PEDS · NICU ·
> PICU · LD · PSYCH · PHARMA (각 735). 누적 태깅 7366 · 350주제. 부서별 코어는 `core-*-<code>`(dept 스코프)로 그 부서 트랙을 이끈다(D-P2-D). 화자
...
> MORGUE·SIM 등)는 35×21 임상 모델이 안 맞아 도달 시 별도 처리 예정. **다음**: 나머지 19부서(병동 계열 SURGWARD·ORTHOWARD → …; 비임상 4곳은
