...
> 11 도메인 · 35주제 · 각 21 상황(기초 6/응용 9/위기 6) = 735. **완료(18/29)**: ER(736) · ICU · OR · WARD · PEDS · NICU · PICU · LD · PSYCH · PHARMA · SURGWARD ·
> ONCO · GERI · RAD · ENDO · DIAL · INFUSION · **HOSPICE** (각 735). 누적 태깅 13247 · 630주제. HOSPICE 화자는 가족(531) 위주(임종·완화), 환자(150)·동료(54). c4·c6 저작본이 21상황 제목을 주제명으로 뭉갠 결함은 map 상황 문자열을 순서대로 title에 주입해 수선, 무효 collabWith(PSY·CHAP·SW·PHARM 25건) 제거. seed 시 v2 스텝은 안정
...
> MORGUE·SIM 등)는 35×21 임상 모델이 안 맞아 도달 시 별도 처리 예정. **다음**: 나머지 18부서(ORTHOWARD → …; 비임상 4곳은
> 설계 결정 필요) → 완료 부서 손저작 113건 태깅 → DB 시드 + 계약 전환 → P3.
>
