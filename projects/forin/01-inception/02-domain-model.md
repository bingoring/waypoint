...
- 디자인 핸드오프(특히 시나리오·퀴즈·맵/인테리어):
  [`../inputs/design-handoff_v3/04_SCREENS.md`](../inputs/design-handoff_v3/04_SCREENS.md),
  [`05_MAP_AND_INTERIORS.md`](../inputs/design-handoff_v3/05_MAP_AND_INTERIORS.md),
  [`reference/scenarios-data.jsx`](../inputs/design-handoff_v3/reference/scenarios-data.jsx)
